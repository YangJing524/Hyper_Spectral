...
###路径初始化
data_path = r'C:\Users\TML\Desktop\多变量\多变量集.xlsx'
...
def main(data,model,model_name,cols,period):
	...
	def fit_and_draw():
		...
		print('current algorithm is 第 %s 期 模型名: %s '%(period,model_name))
		...
		my_data=[{'periods':period},{'model':model_name},{'R2':R_2},{'r2':r_2},{'RMSE':rmse},{'RE%':RE*100}]
		...
		plt.savefig(os.path.join(HS_path,'./%s_%s.png'%(period,model_name)))
